...
<script async class="speakerdeck-embed" data-id="cdf29248634b4bfd973e4ec1191f9f4b" data-ratio="1.77777777777778" src="//speakerdeck.com/assets/embed.js"></script>
<div style="margin-bottom:5px"> <strong> <a href="https://speakerdeck.com/jeffgoldsmith/aphrea-visualization" title="APHREA: Visualization" target="_blank">APHREA: Visualization</a> </strong> from <strong><a href="https://speakerdeck.com/jeffgoldsmith" target="_blank">Jeff Goldsmith</a></strong>. </div>

Slides can be downloaded [here](./slides/ShortCourse_Visualization.pdf).


## Example

In the following, we'll use some changes to the default colors in `ggplot`. Include this code chunk at the top of your R Markdown file to get the same colors:
...
This step isn't necessary but it does make the plots a bit nicer! More information about these changes (to the color palette and default theme) can be found in [this lecture](https://www.p8105.com/visualization_pt2.html) from P8105. 



First, I'll create an R Markdown file for this module of the short course, and load the `tidyverse` package in "setup" code chunk. 
...
We'll be working with NOAA weather data, which is downloaded using `rnoaa::meteo_pull_monitors` function in the code chunk below. Because this process can take some time, I'll cache the code chunk. 
